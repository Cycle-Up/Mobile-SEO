    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/keuzehulp/budget" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Duurzaam waterfilter op lange termijn</h3>
              <p className="text-sm text-gray-600">Hoe ecologische filters zich verhouden tot wegwerpalternatieven over een levensduur van 10 jaar.</p>
            </Link>
            <Link href="/filtertechnieken/actief-kool" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Actief kool: hernieuwbaar filtermateriaal</h3>
              <p className="text-sm text-gray-600">Hoe biokoolfilters en hernieuwbare actief kool een lagere ecologische voetafdruk hebben.</p>
            </Link>
          </div>
        </section>
        ...
        <AffiliateCTA
          ...
          content="beste-waterfilter-ecologisch-cta"
          label="Minder flessen: bekijk de zuiver-water-kranen"
