    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater/zware-metalen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Lood en zware metalen in oudbouw</h3>
              <p className="text-sm text-gray-600">Hoe loden leidingen in oude huizen lood in drinkwater kunnen brengen en welke filter helpt.</p>
            </Link>
            <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Omgekeerde osmose tegen lood</h3>
              <p className="text-sm text-gray-600">Waarom RO 95-99% van lood en zware metalen verwijdert en dus geschikt is voor oudbouw.</p>
            </Link>
          </div>
        </section>
        ...
        <AffiliateCTA
          ...
          content="beste-waterfilter-ouder-huis-cta"
