    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-12">
        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/sedimentfilter/werking" className="group border border-gray-200 rounded-xl p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <p className="font-semibold text-gray-800 group-hover:text-[#005F8A] transition-colors mb-1 text-sm">Hoe werkt een sedimentfilter?</p>
              <p className="text-xs text-gray-500">Mechanische filtratie, micronwaardes en filtertypen uitgelegd</p>
            </Link>
            ...
            <Link href="/waterfilter/soorten" className="group border border-gray-200 rounded-xl p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <p className="font-semibold text-gray-800 group-hover:text-[#005F8A] transition-colors mb-1 text-sm">Alle filtersoorten vergeleken</p>
              <p className="text-xs text-gray-500">Overzicht van alle waterfiltertypes en hun toepassingen</p>
            </Link>
            <Link href="/filtertechnieken/actief-kool" className="group border border-gray-200 rounded-xl p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <p className="font-semibold text-gray-800 group-hover:text-[#005F8A] transition-colors mb-1 text-sm">Actief kool als vervolgfilter</p>
              <p className="text-xs text-gray-500">Koolstoffiltratie na uw sedimentfilter voor betere smaak</p>
            </Link>
          </div>
        </section>
