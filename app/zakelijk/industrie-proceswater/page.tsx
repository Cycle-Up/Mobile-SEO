        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Omgekeerde osmose industrieel proceswater</h3>
              <p className="text-sm text-gray-600">Hoe industriële RO-installaties zuiver proceswater leveren voor productie en stoom.</p>
            </Link>
            <Link href="/stoffen-in-drinkwater/kalk-mineralen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Kalk en mineralen in proceswater</h3>
              <p className="text-sm text-gray-600">Hoe hardheid en TDS-waarde proceskwaliteit en boilerefficiency beïnvloeden in industriële toepassingen.</p>
            </Link>
          </div>
        </section>
