...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Voor een standaard 4-staps RO-systeem: sedimentfilter (€5–€15) + pre-koolstof (€8–€20) + post-koolstof (€8–€20) = €20–€55 per jaar. Het RO-membraan (€30–€80) eens per 2–5 jaar. Totaal gemiddeld €30–€75 per jaar. Bij de PureAqua 4-in-1 kraan met osmose kosten de filters gemiddeld circa €150 per jaar (fabrikantprijzen omgerekend).',
  },
  {
