      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/onderhoud/osmose-filter-vervangen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Gedetailleerde handleiding voor het vervangen van RO-filters.</p>
          </Link>
          <Link href="/onderhoud/koolstoffilter-levensduur" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Wanneer is een koolstoffilterpatroon uitgeput?</p>
          </Link>
          <Link href="/waterfilter/onderhoud" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Waterfilter onderhoud handleiding</h3>
            <p className="text-sm text-gray-600">Complete gids met risico's bij verwaarlozing per filtertype.</p>
          </Link>
          <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Omgekeerde osmose uitgelegd</h3>
            <p className="text-sm text-gray-600">Werking en componenten van een RO-systeem.</p>
          </Link>
        </div>
      </section>
