      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/stoffen-in-drinkwater/chloor-bijproducten" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">THM en HAA: welke desinfectiebijproducten zijn schadelijk?</p>
          </Link>
          <Link href="/waterfilter/chloor" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Chloorfilter voor kraanwater</h3>
            <p className="text-sm text-gray-600">Hoe verwijder je chloor uit leidingwater?</p>
          </Link>
          <Link href="/filtertechnieken/actief-kool" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Hoe werkt een actief koolfilter en wat verwijdert het?</p>
          </Link>
          <Link href="/drinkwaternormen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Nederlandse drinkwaternormen</h3>
            <p className="text-sm text-gray-600">EU-normen voor drinkwaterkwaliteit op een rij.</p>
          </Link>
        </div>
      </section>
