      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/waterfilter/keuken-installatie" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Stap-voor-stap installatiegids voor filters onder het aanrecht.</p>
          </Link>
          <Link href="/waterfilter/kopen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Vergelijking van de beste waterfilters per budget en woontype.</p>
          </Link>
          <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Omgekeerde osmose</h3>
            <p className="text-sm text-gray-600">Hoe RO-filtratie werkt en waarom het de complete wateroplossing is.</p>
          </Link>
          <Link href="/keuzehulp/huurwoning" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Welke systemen passen zonder verbouwing in een huurwoning?</p>
          </Link>
        </div>
      </section>
