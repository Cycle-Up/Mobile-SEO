    ...
    <>
      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Link href="/waterfilter/radium" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Radium in drinkwater</h3>
            <p className="text-sm text-gray-600">Radium en radon in grondwater: risicogebieden, EU-normen en hoe een osmosefilter helpt.</p>
          </Link>
          <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Omgekeerde osmose</h3>
            <p className="text-sm text-gray-600">Hoe omgekeerde osmose werkt en waarom het 90-97% van strontium en andere ionen verwijdert.</p>
          </Link>
