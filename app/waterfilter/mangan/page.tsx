      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Link href="/waterfilter/mangaanfilter" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Mangaanfilter voor water</h3>
            <p className="text-sm text-gray-600">Alles over mangaanfilters: typen, werking en wanneer u er een nodig heeft.</p>
          </Link>
