      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-14">
        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Link href="/kokend-water-kraan/prijs" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Kokend water kraan prijs</h3>
              <p className="text-sm text-gray-600">Overzicht van de kosten voor kokend water kranen inclusief installatie.</p>
            </Link>
