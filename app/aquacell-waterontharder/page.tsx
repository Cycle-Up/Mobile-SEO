  ...
  return (
    <>
      <SchemaOrg
        ...
        article={{
          title: 'Aquacell waterontharder: modellen, ervaringen en alternatief',
          description: 'Aquacell waterontharder: wat biedt dit betaalbare merk, voor wie is het geschikt en waar let je op? Plus een eerlijke afweging en alternatieven in 2026.',
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-12">
        ...
        <AffiliateCTA
          destination="aquacell"
          campaign="waterontharder"
          content="aquacell-alternatief-cta"
          label="Bekijk de AquaCell waterontharder bij PureAqua"
          title="Een compacte waterontharder aanschaffen?"
          sub="Bekijk de AquaCell waterontharder bij onze partner PureAqua."
        />
