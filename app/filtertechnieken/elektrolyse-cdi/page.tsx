        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater/kalk-mineralen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Mineralen in drinkwater: elektrolyse impact</h3>
              <p className="text-sm text-gray-600">Welke mineralen elektrolyse-CDI uit water verwijdert en hoe dit verschilt van osmose.</p>
            </Link>
            <Link href="/vergelijken/omgekeerde-osmose-vergelijken" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">CDI vergeleken met RO</h3>
              <p className="text-sm text-gray-600">Hoe capacitieve deïonisatie zich verhoudt tot omgekeerde osmose op energie, kosten en effectiviteit.</p>
            </Link>
          </div>
        </section>
