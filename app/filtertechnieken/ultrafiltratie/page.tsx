        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater/microbiologisch" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              ...
              <p className="text-sm text-gray-600">Hoe ultrafiltratie bacteriën en parasieten (0.01-0.1 micron) tegenhoudt en virussen gedeeltelijk filtert.</p>
            </Link>
            <Link href="/keurmerken/nsf-ansi-42-53" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">NSF 42/53: keurmerk ultrafiltratie</h3>
              <p className="text-sm text-gray-600">Wat NSF certificering voor ultrafiltratie-modules betekent en welke claims wetenschappelijk getest zijn.</p>
            </Link>
          </div>
        </section>
      </main>
