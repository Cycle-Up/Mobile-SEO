        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater/kalk-mineralen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Kalk en mineralen: boiler aanslag</h3>
              <p className="text-sm text-gray-600">Hoe kalkhoudend leidingwater aanslag veroorzaakt in de boiler van uw kokend water kraan en wat de gevolgen zijn.</p>
            </Link>
            <Link href="/onderhoud/kokend-water-kraan-onderhoud" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Boiler reinigen en onderhoud</h3>
              <p className="text-sm text-gray-600">Hoe u de boiler van uw kokend water kraan schoonmaakt, ontkalkt en controleert op lekkage of drukproblemen.</p>
            </Link>
          </div>
        </section>
