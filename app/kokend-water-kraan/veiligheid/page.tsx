        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/keurmerken/ce-markering" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">CE-markering: veiligheidsnorm voor kranen</h3>
              <p className="text-sm text-gray-600">Wat CE-markering betekent voor kokend water kranen en welke normen (EN 61770, NEN 1006) gelden bij veilige productie.</p>
            </Link>
            <Link href="/keuzehulp/baby-gezin" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Waterfilter voor baby's en gezinnen</h3>
              <p className="text-sm text-gray-600">Welk water het veiligst is voor baby's en hoe u de waterfilter kiest die past bij een gezin met jonge kinderen.</p>
            </Link>
          </div>
        </section>
