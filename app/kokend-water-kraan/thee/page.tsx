        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater/kalk-mineralen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Kalk in theewater: effect op smaak</h3>
              <p className="text-sm text-gray-600">Waarom kalkrijk water thee bitter maakt en hoe u met gefilterd water de volledige theekenmerken tot zijn recht laat komen.</p>
            </Link>
            <Link href="/filtertechnieken/actief-kool" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Actief kool voor geur- en smaakverbetering</h3>
              <p className="text-sm text-gray-600">Hoe actief koolfilters chloor en organische stoffen verwijderen die de theeervaring verstoren.</p>
            </Link>
          </div>
        </section>
