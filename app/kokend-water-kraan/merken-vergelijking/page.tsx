        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/keurmerken/ce-markering" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">CE-markering per merk vergelijken</h3>
              <p className="text-sm text-gray-600">Hoe u bij merkenvergelijking let op CE-certificering, EN 61770-conformiteit en beschikbare conformiteitsverklaringen.</p>
            </Link>
            <Link href="/vergelijken/kokend-water-kraan-merken" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Uitgebreide merkenvergelijking hub</h3>
              <p className="text-sm text-gray-600">Alle kokend water kraan merken op een rij: Quooker, Grohe Red, PureAqua, Franke, Brita en meer naast elkaar.</p>
            </Link>
          </div>
        </section>
