        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/keurmerken/ce-markering" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">CE-markering en installatienormen</h3>
              <p className="text-sm text-gray-600">Welke CE-normen gelden voor kokend water kranen en waarom een erkend installateur NEN 1006 moet naleven.</p>
            </Link>
            <Link href="/onderhoud/kokend-water-kraan-onderhoud" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Onderhoud kokend water kraan</h3>
              <p className="text-sm text-gray-600">Hoe u na installatie de kokend water kraan onderhoudt: ontkalkingsschema, filterwissel en periodieke controle.</p>
            </Link>
          </div>
        </section>
