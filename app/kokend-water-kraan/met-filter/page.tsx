        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Omgekeerde osmose: de filterstandaard</h3>
              <p className="text-sm text-gray-600">Hoe osmosefilters in kokend water kranen werken, welke verontreinigingen ze verwijderen en wanneer het membraan vervangen moet.</p>
            </Link>
            <Link href="/keurmerken/nsf-ansi-58" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">NSF 58: certificering osmosefilters</h3>
              <p className="text-sm text-gray-600">Wat NSF/ANSI 58 certificering betekent voor de ingebouwde osmosemodule van uw kokend water kraan.</p>
            </Link>
          </div>
        </section>
      </div>
