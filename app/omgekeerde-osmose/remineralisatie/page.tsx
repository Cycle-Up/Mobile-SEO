...
export const metadata: Metadata = {
  ...
  description: 'Osmosewater remineraliseren: calcietpatroon toevoegen, mineraaldruppels, mengen met leidingwater. TDS verhogen naar 50-80 mg/L voor optimale smaak en pH 7,0-7,5.',
