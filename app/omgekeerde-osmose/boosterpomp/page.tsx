      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/omgekeerde-osmose/waterdruk" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Waterdruk en osmose</h3>
            <p className="text-sm text-gray-600">Alles over waterdruk bij omgekeerde osmose: minimum, meten en verbeteren.</p>
          </Link>
          <Link href="/omgekeerde-osmose/druk" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            <h3 className="font-semibold text-[#005F8A] mb-1">Druk osmosefilter</h3>
            <p className="text-sm text-gray-600">Hoe druk de werking van uw osmosefilter beinvloedt en wat u kunt doen.</p>
          </Link>
          <Link href="/omgekeerde-osmose/installatie" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Stap-voor-stap gids voor het installeren van uw osmosefilter.</p>
          </Link>
