    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-12">
        ...
        <AffiliateCTA
          ...
          content="vergelijken-quooker-vs-fonteq-cta"
          label="PureAqua 4-in-1 kraan als alternatief"
