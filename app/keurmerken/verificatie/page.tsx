        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Welke stoffen test het filter?</h3>
              <p className="text-sm text-gray-600">Overzicht van stoffen in drinkwater waarvoor filters gecertificeerd worden.</p>
            </Link>
            <Link href="/keurmerken" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Terug naar keurmerken overzicht</h3>
              <p className="text-sm text-gray-600">Alle waterfilter keurmerken: NSF, Kiwa, ACS, CE en WRAS op een rij.</p>
            </Link>
          </div>
        </section>
