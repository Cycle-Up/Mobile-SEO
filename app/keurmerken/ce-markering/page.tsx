        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Stoffen in drinkwater: EU standaarden</h3>
              <p className="text-sm text-gray-600">Welke stoffen worden gereguleerd door de EU Drinkwaterrichtlijn?</p>
            </Link>
            <Link href="/drinkwaternormen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">EU drinkwaternormen</h3>
              <p className="text-sm text-gray-600">Europese grenswaarden voor drinkwaterkwaliteit en de implementatie in Nederland.</p>
            </Link>
          </div>
        </section>
