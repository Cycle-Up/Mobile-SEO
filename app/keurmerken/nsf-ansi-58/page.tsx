        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/stoffen-in-drinkwater/pfas-overzicht" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">PFAS: NSF/ANSI 58 gecertificeerde filters</h3>
              <p className="text-sm text-gray-600">Welke PFAS-stoffen worden getest en wat zeggen de reductiepercentages?</p>
            </Link>
            <Link href="/stoffen-in-drinkwater/zware-metalen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Lood en zware metalen filteren</h3>
              <p className="text-sm text-gray-600">Welke zware metalen zitten in drinkwater en hoe verwijdert een osmosefilter ze?</p>
            </Link>
          </div>
        </section>
