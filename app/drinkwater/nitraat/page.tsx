    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-gray-700 text-sm">Voor babyvoeding bij hoog nitraat: gebruik tijdelijk bronwater met nitraat &lt;10 mg/L. Niet duurzaam als permanente oplossing. Zie ook onze vergelijking <Link href="/kennisbank/kraanwater-versus-flessenwater" className="text-[#005F8A] underline">kraanwater vs. flessenwater</Link>.</p>
          </div>
        </div>
      ...
      <section className="mt-8">
        ...
        <p className="text-gray-600 text-sm mt-6">
          Zie ook: <Link href="/drinkwater/kwaliteit-test" className="text-[#005F8A] underline">drinkwater testen</Link> en <Link href="/drinkwater/baby" className="text-[#005F8A] underline">drinkwater voor baby</Link>.
        </p>
      </main>
    </>
  );
