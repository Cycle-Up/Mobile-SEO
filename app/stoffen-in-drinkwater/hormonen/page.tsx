        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Osmose verwijdert hormoonresten</h3>
              <p className="text-sm text-gray-600">Hoe omgekeerde osmose farmaceutische microverontreinigingen uit drinkwater filtert.</p>
            </Link>
            <Link href="/waterfilter/pfas" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Hormonen en PFAS: vergelijkbare aanpak</h3>
              <p className="text-sm text-gray-600">PFAS en hormoonresten vragen om soortgelijke filteroplossingen voor huishoudelijk gebruik.</p>
            </Link>
            <Link href="/drinkwaternormen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">EU-normen voor hormoonresten in water</h3>
              <p className="text-sm text-gray-600">Alle parameternormen uit het Drinkwaterbesluit inclusief opkomende stoffen.</p>
            </Link>
          </div>
        </section>
