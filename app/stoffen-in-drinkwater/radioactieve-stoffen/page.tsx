        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Link href="/filtertechnieken/omgekeerde-osmose" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Osmose verwijdert radioactieve stoffen</h3>
              <p className="text-sm text-gray-600">Hoe omgekeerde osmose uranium en radium met 90-99% efficientie filtert.</p>
            </Link>
            <Link href="/drinkwaternormen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">EU-normen voor radioactiviteit</h3>
              <p className="text-sm text-gray-600">Parameternormen voor uranium en andere radioactieve stoffen in drinkwater.</p>
            </Link>
            <Link href="/putwater/zware-metalen" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Zware metalen en radio-actieve stoffen aanpak</h3>
              <p className="text-sm text-gray-600">Vergelijkbare aanpak voor zware metalen en radioactieve stoffen in putwater.</p>
            </Link>
          </div>
        </section>
