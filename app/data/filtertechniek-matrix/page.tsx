...
const KEY = "filtertechniek-matrix";
const ds = DATASETS[KEY];

export const metadata: Metadata = {
  title: "Filtertechnieken: poriegrootte en werking (dataset)",
  ...
  openGraph: { title: "Filtertechnieken: poriegrootte en werking (dataset)", description: "Overzicht van waterfiltertechnieken met indicatieve poriegrootte en wat ze wel en niet aanpakken.", url: 'https://waterfilterplatform.nl/data/' + KEY, type: 'website', locale: 'nl_NL' },
};

export default function FiltertechniekMatrixDataset() {
  return (
    <>
