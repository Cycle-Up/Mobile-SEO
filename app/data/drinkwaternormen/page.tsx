...
const KEY = "drinkwaternormen";
const ds = DATASETS[KEY];

export const metadata: Metadata = {
  title: "Drinkwaternormen Nederland (dataset)",
  ...
  openGraph: { title: "Drinkwaternormen Nederland (dataset)", description: "Wettelijke maximumwaarden voor stoffen in drinkwater (Drinkwaterbesluit / EU-richtlijn 2020/2184).", url: 'https://waterfilterplatform.nl/data/' + KEY, type: 'website', locale: 'nl_NL' },
};

export default function DrinkwaternormenDataset() {
  return (
    <>
          ...
          <table className="w-full min-w-[640px] text-sm border-collapse">
            <thead>
              <tr className="bg-[#E0F2FE]">
                  ...
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">Norm</th>
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">Eenheid</th>
