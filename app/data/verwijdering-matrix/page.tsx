...
const KEY = "verwijdering-matrix";
const ds = DATASETS[KEY];

export const metadata: Metadata = {
  title: "Verwijdering per filtertype (indicatief) (dataset)",
  description: "Indicatieve, kwalitatieve verwijdering van veelvoorkomende stoffen per filtertype. Geen exacte percentages; raadpleeg de gecertificeerde productspecificati",
  alternates: { canonical: 'https://waterfilterplatform.nl/data/' + KEY },
  openGraph: { title: "Verwijdering per filtertype (indicatief) (dataset)", description: "Indicatieve, kwalitatieve verwijdering van veelvoorkomende stoffen per filtertype. Geen exacte percentages; raadpleeg de gecertificeerde productspecificati", url: 'https://waterfilterplatform.nl/data/' + KEY, type: 'website', locale: 'nl_NL' },
};

export default function VerwijderingMatrixDataset() {
  return (
    <>
          ...
          <table className="w-full min-w-[640px] text-sm border-collapse">
            <thead>
              <tr className="bg-[#E0F2FE]">
                  ...
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">Lood</th>
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">Nitraat</th>
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">PFAS</th>
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">Kalk</th>
                  <th scope="col" className="text-left py-3 px-3 font-semibold text-[#003F5C]">Microplastics</th>
              </tr>
            </thead>
            <tbody>
              {ds.rows.map((row, i) => (
