        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/osmose-water/remineralisatie" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              ...
              <p className="text-sm text-gray-600">Uitleg over remineralisatiecartridges en hoe ze mineralen teruggeven aan osmosewater.</p>
            </Link>
            ...
            <Link href="/brouwwater/remineraliseren" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              ...
              <p className="text-sm text-gray-600">Hoe brouwers osmosewater aanpassen met mineralen voor bier en specialiteitskoffie.</p>
            </Link>
