...
export const metadata: Metadata = {
  ...
  description:
    'Thuiswijnmakers en kleine wijnmakerijen gebruiken osmosewater als basiswater voor remineralisatie op maat. pH-instelling, gist-gezondheid en sulfaatgehalte.',
