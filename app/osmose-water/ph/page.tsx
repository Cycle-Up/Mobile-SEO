      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/alkalisch-water/gezondheid" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Wat alkalisch water is en of een hogere pH gezondheidsvoordelen biedt.</p>
          </Link>
          ...
          <Link href="/osmose-water/remineralisatie" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
            ...
            <p className="text-sm text-gray-600">Hoe en waarom je mineralen toevoegt aan osmosewater voor betere pH.</p>
          </Link>
