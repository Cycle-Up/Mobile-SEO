        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/filtertechnieken/ionenwisseling" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Hoe ionenwisseling werkt</h3>
              <p className="text-sm text-gray-600">Begrijp de werking van ionenwisseling en waarom storingen in het harsbed optreden.</p>
            </Link>
            <Link href="/onderhoud/waterontharder-zout" className="block border border-gray-200 rounded-lg p-4 hover:border-[#005F8A] hover:shadow-sm transition-all">
              <h3 className="font-semibold text-[#005F8A] mb-1">Waterontharder zout bijvullen</h3>
              <p className="text-sm text-gray-600">Wanneer en hoe u zout bijvult om storingen door een leeg reservoir te voorkomen.</p>
            </Link>
          </div>
        </section>
