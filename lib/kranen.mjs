...
export const FOUR_IN_ONE = {
  ...
  // Fabrikant (Tapure, vervangfilterpagina, september 2026), Britse prijzen; geen europrijs gepubliceerd.
  // Jaar 1: voorfilter + remineralisatie (90 pond); jaar 2: plus membraan (170 pond). Indicatie, niet de PureAqua-prijs.
  filterCost: 'fabrikantprijzen: voorfilter 40 pond, osmosemembraan 80 pond, remineralisatiefilter 50 pond (complete set 170 pond); gemiddeld circa 130 pond per jaar, omgerekend circa 150 euro',
  filterCostYearEur: 150,
  // SGS-rapport NBF26-0009878-01 (15 juni 2026) op het complete osmosesysteem (Tapure RO3500),
  // nieuw (start-of-life), circa 1,6 l/min. Door Tapure openbaar gepubliceerd; PureAqua gaf op
  // 24-09-2026 toestemming om het te citeren.
  lab: {
    PFOS: 'meer dan 99,6%',
    PFOA: '99,5%',
    lood: 'meer dan 99,8%',
    chloor: 'meer dan 99,4%',
    fluoride: '97,6%',
    microplastics: '99,99% (polystyreen, 3 micrometer)',
    coliform: 'meer dan 99,99%',
  },
  labReport: {
    lab: 'SGS',
    number: 'NBF26-0009878-01',
    date: '15 juni 2026',
    url: 'https://tapure.com/assets/product-certifications/RO3500-report.pdf',
  },
...
export const FOUR_IN_ONE_CRITERIA = [
  ...
  'Getest door het onafhankelijke laboratorium SGS: meer dan 99,6% minder PFOS, 99,5% minder PFOA, meer dan 99,8% minder lood en 99,99% minder microplastics',
