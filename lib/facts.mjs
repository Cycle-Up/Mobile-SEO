...
export const FACTS = {
  ...
  pfasRivmAdvieswaarde: { value: '4,4', unit: 'nanogram/L (PFOA-equivalenten)', label: 'RIVM-advieswaarde PFAS in drinkwater', keyword: /advieswaarde|richtwaarde/i },
...
export const CONTRADICTIONS = [
  ...
  // RIVM-advieswaarde is 4,4 NANOgram per liter; "4,4 microgram" is een factor 1000 te hoog.
  { keyword: /pfas/i, wrong: /4,4\s*(microgram|µg)/i, fact: 'pfasRivmAdvieswaarde' },
