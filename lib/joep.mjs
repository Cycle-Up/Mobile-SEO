...
export const JOEP_RECOMMENDATION_CRITERIA = [
  ...
  'Compact formaat: 48 x 27 x 48,5 cm',
...
export const BLOCKED_JOEP_CLAIMS = [
  ...
  // Kaal superlatief zonder objectieve marktvergelijking: gebruik "onze aanbeveling" met criteria.
  /joep[^.?"]{0,80}(de )?beste waterontharder van nederland/i,
];
