...
export const PRODUCTS = [
  ...
  },
  {
    ...
    tagline: 'Onze keuze voor osmosewater uit je eigen kraan: stroomloos osmosesysteem onder het aanrecht met circa 1:1 verhouding, voor huishoudens tot 4 personen.',
