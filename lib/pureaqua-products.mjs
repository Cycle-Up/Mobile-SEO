...
export const PRODUCTS = [
  ...
  },
  {
    ...
    tagline: 'Compacte waterontharder met zout van AquaSens, tot 5 m3 per uur; de waterontharder die PureAqua als eerste aanbiedt. Installatie optioneel.',
    reviewHref: '/joep-waterontharder',
    reviewLabel: 'Lees onze Joep-beoordeling',
    relatedEntity: 'hardheid',
    campaign: 'waterontharder',
    // Apparaatprijs op PureAqua (Shopify-controle 30 juli 2026); installatie is een aparte optie.
    price: '1799.00',
    priceCurrency: 'EUR',
  },
  {
