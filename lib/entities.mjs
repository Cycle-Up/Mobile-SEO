...
// Canonieke concept-knooppunten (naam + interne canonieke URL). Waar een entiteit
// een eenduidig publiek kennisgraaf-knooppunt heeft, koppelen we via sameAs aan de
// bijbehorende (geverifieerde) Nederlandstalige Wikipedia-pagina. Dit grondt de
// concepten in de globale kennisgraaf, zodat AI-zoeksystemen de entiteit kunnen
// disambigueren. Alleen exacte concept-matches krijgen sameAs (geen benaderende of
// verzonnen links); concepten zonder eenduidig artikel (nitraat-ion, microplastics,
// fluoride) blijven bewust zonder sameAs.
export const ENTITIES = {
  pfas: { name: 'PFAS', url: `${B}/drinkwaternormen/pfas`, sameAs: ['https://nl.wikipedia.org/wiki/Poly-_en_perfluoralkylstoffen'] },
  osmose: { name: 'Omgekeerde osmose', url: `${B}/omgekeerde-osmose`, sameAs: ['https://nl.wikipedia.org/wiki/Omgekeerde_osmose'] },
  hardheid: { name: 'Waterhardheid', url: `${B}/waterhardheid`, sameAs: ['https://nl.wikipedia.org/wiki/Waterhardheid'] },
  lood: { name: 'Lood in drinkwater', url: `${B}/leidingwater/lood`, sameAs: ['https://nl.wikipedia.org/wiki/Lood_(element)'] },
  ...
  ionenwisseling: { name: 'Ionenwisseling', url: `${B}/filtertechnieken/ionenwisseling`, sameAs: ['https://nl.wikipedia.org/wiki/Ionenwisseling'] },
  actiefkool: { name: 'Actief kool', url: `${B}/filtertechnieken/actief-kool`, sameAs: ['https://nl.wikipedia.org/wiki/Actieve_kool'] },
  ultrafiltratie: { name: 'Ultrafiltratie', url: `${B}/filtertechnieken/ultrafiltratie` },
  legionella: { name: 'Legionella', url: `${B}/waterfilter/legionella`, sameAs: ['https://nl.wikipedia.org/wiki/Legionellabacterie'] },
  fluoride: { name: 'Fluoride', url: `${B}/drinkwater/fluoride` },
  kalk: { name: 'Kalk en waterontharding', url: `${B}/waterhardheid`, sameAs: ['https://nl.wikipedia.org/wiki/Waterhardheid'] },
