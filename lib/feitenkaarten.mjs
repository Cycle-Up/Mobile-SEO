...
export const FACT_CARDS = {
  purefilter: {
    ...
    rows: [
      ...
      ['Bewijs', `Equinox Labs (2026): ${PUREFILTER.pfasReduction} minder ${PUREFILTER.pfasTested.join(', ')}, nieuw filter, gespiked water`],
  ...
  fourInOne: {
    ...
    rows: [
      ...
      ['Bewijs', `SGS, nieuw systeem: PFOS ${FOUR_IN_ONE.lab.PFOS}, PFOA ${FOUR_IN_ONE.lab.PFOA}, lood ${FOUR_IN_ONE.lab.lood} minder`],
