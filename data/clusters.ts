...
export const clusters: ClusterMeta[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { title: 'Woonboot', href: '/beste-waterfilter/woonboot', description: 'Drukwisselingen, slangsysteem en mobiele filteropties.' },
  ...
  },
  {
    ...
    pages: [
      ...
      { title: 'Kokend water kraan merken', href: '/vergelijken/kokend-water-kraan-merken', description: 'Quooker, PureAqua, Grohe, Franke: prijzen, features, onderhoud.' },
      ...
      { title: 'Osmose vs bronwater', href: '/vergelijken/osmose-vs-bronwater', description: 'TDS, mineralen, prijs en milieu-impact vergeleken.' },
      { title: 'Omgekeerde osmose vergelijken', href: '/vergelijken/omgekeerde-osmose-vergelijken', description: 'RO-systemen naast elkaar: prijs, capaciteit, certificering.' },
      { title: 'Waterontharder vergelijken', href: '/vergelijken/waterontharder-vergelijken', description: 'Ionenwisselaars, magnetisch, zoutloos: vergelijking effectiviteit.' },
    ],
    ctaContext: 'osmose',
    commercialLinks: [
      { label: 'Osmose filter kopen', href: '/omgekeerde-osmose/kopen' },
  ...
  },
  {
    ...
    pages: [
      ...
      { title: 'Kokend water kraan onderhoud', href: '/onderhoud/kokend-water-kraan-onderhoud', description: 'Ontkalken, filter wisselen en boiler controleren.' },
      ...
      { title: 'Koolstoffilter levensduur', href: '/onderhoud/koolstoffilter-levensduur', description: 'GAC vs CTO: wanneer is actief kool verzadigd en moet je wisselen?', badge: 'Nieuw' },
  ...
  },
  {
    ...
    pages: [
      ...
      { title: 'Industrie en proceswater', href: '/zakelijk/industrie-proceswater', description: 'Zuiver water voor productie, lab, koelinstallaties: RO op maat.', badge: 'Nieuw' },
