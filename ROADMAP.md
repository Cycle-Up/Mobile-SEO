...
- Content-backlog Thema 11 (editoriale bulk-verrijking, uitgesteld): item 88 (2e takeaways-ronde ~50 artikelen), 89 (FAQ-secties toevoegen), 92 (quickAnswer-outliers herschrijven naar 40-60 woorden), 93 (bron-/datumactualisatie 30 oudste YMYL), 94 (praktijkvoorbeelden toevoegen), 95 (proza naar datatabellen). Reden: grootschalige per-artikel-redactie over honderden bestaande artikelen; automatiseren zou templated/dunne of redundante content geven (tegen people-first/no-thin-content). Beter in gerichte, gereviewde redactierondes. takeaways-feature + metric staan klaar (check-aeo).
