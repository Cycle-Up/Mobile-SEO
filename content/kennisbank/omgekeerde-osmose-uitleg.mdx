...
Wil je een osmosesysteem aanschaffen op basis van deze kennis? Bekijk dan ons uitgebreide overzicht van [omgekeerde osmose filters kopen](/omgekeerde-osmose/kopen) of lees meer over de specifieke [osmose filter](/osmose-filter) opties voor thuisgebruik. Vergelijk ook [ultrafiltratie](/filtertechnieken/ultrafiltratie) als alternatief voor situaties waar volledige demineralisatie niet gewenst is, en lees de [PFAS-pagina](/stoffen-in-drinkwater/pfas-overzicht) voor informatie over één van de belangrijkste stoffen die osmose verwijdert.
