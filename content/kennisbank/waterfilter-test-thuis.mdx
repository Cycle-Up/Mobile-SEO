...
quickAnswer: "Hoe test je een waterfilter thuis? TDS meter, pH-strips, nitraat- en chloortest: wat meet je ermee, wat mist je, en wanneer is een labtest nodig? Je hebt een waterfilter geïnstalleerd — maar werkt het ook? Veel mensen gaan af op wat ze proeven of zien, maar dat vertelt lang niet het hele verhaal."
---
...
Zie ook: [PFAS in drinkwater](/stoffen-in-drinkwater/pfas-overzicht) en [drinkwaternormen in Nederland](/drinkwaternormen).
