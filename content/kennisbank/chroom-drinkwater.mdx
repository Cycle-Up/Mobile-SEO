...
| Methode | Verwijdering Cr(VI) | Opmerkingen |
|---|---|---|
| Omgekeerde osmose | 85–97% | Meest effectieve huishoudoplossing |
| Ionenwisseling (sterk basisch anionenhars) | 90–99% | Specifiek hars vereist |
| Actief koolstoffilter | < 10% | Niet geschikt voor chroomverwijdering |
| Destillatie | 95–99% | Praktisch, maar energie-intensief |
| Waterfilterkan (Brita e.d.) | Verwaarloosbaar | Geen bescherming tegen chroom-6 |

Voor de meest effectieve bescherming thuis is een osmosefilter de aangewezen keuze. Bekijk ons volledig aanbod via [omgekeerde osmose filters kopen](/omgekeerde-osmose/kopen) — de PureAqua 4-in-1 kraan combineert osmosefiltratie met een kokendwaterfunctie in één elegant systeem.

## Wat kun je zelf doen?

### 1. Laat je water analyseren

Als je twijfelt aan de waterkwaliteit bij jouw locatie — zeker bij gebruik van een eigen put in een industrieel gebied — laat dan een gecertificeerde wateranalyse uitvoeren. Een volledig drinkwateronderzoek inclusief chroom kost €70–€150 bij een erkend laboratorium.

### 2. Informeer bij je drinkwaterbedrijf

Drinkwaterbedrijven zijn wettelijk verplicht hun meetresultaten openbaar te maken. Op de website van je drinkwaterbedrijf vind je in de meeste gevallen de actuele kwaliteitsgegevens per regio. In sommige gevallen kun je ook bellen voor specifieke informatie over chroomgehaltes.

### 3. Installeer een RO-filter

Als je extra zekerheid wilt — of als de analyse chroom aantoont boven aanvaardbare niveaus — biedt een omgekeerde-osmosefilter de meest betrouwbare bescherming. Zie ook onze pagina over [omgekeerde osmose](/omgekeerde-osmose) voor uitleg over hoe het systeem werkt.

### 4. Gebruik geen waterfilterkan als enige bescherming

Een Brita of vergelijkbare filterkan heeft geen noemenswaardige werking op chroom-6. Als bescherming tegen dit specifieke contaminant is een filterkan onvoldoende.

## Wettelijk kader en toekomstige normen

De EU werkt aan een aanscherping van de drinkwaterkwaliteitsrichtlijn. Wetenschappelijk adviseurs pleiten voor een aparte, strengere norm voor chroom-6 (los van totaal chroom), vergelijkbaar met de benadering van de VS. Wanneer een herziene norm wordt doorgevoerd, zullen drinkwaterbedrijven hun zuiveringsprocessen moeten aanpassen — wat ze doorgaans al lang voor de officiële deadline doen.

## Veelgestelde vragen

### Zit er chroom-6 in mijn kraanwater?

In veruit de meeste gevallen: nee, niet in meetbare concentraties. Nederlands drinkwater van de waterleiding voldoet ruimschoots aan alle geldende normen. Bij gebruik van een eigen put in een industrieel gebied is een analyse verstandig.

### Heeft het schandaal in Dordrecht effect gehad op het drinkwater?

Nee. Het Dordrechtse schandaal ging primair over blootstelling van werknemers op het fabrieksterrein. Het drinkwater in Dordrecht wordt gewonnen uit de Lek en is uitgebreid gezuiverd — er zijn geen meldingen van chroomverontreiniging boven de norm in het kraanwater.

### Is gefilterd water (RO) 100% vrij van chroom-6?

Een RO-filter verwijdert 85–97% van het aanwezige chroom-6. Bij de uiterst lage concentraties in leidingwater resulteert dit in restconcentraties die meerdere ordes lager zijn dan de norm. Voor de overgrote meerderheid van gebruikers biedt een RO-filter ruimschoots voldoende bescherming.
