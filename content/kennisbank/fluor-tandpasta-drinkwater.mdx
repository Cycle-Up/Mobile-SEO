...
Bij de concentraties die in Nederland voorkomen (<0,4 mg/L) is fluorose **volstrekt niet aan de orde**. Dit risico speelt alleen in gebieden met van nature hoog fluoride (> 2 mg/L) of bij excessief gebruik van fluoridepreparaten.
...
|---|---|---|
| Omgekeerde osmose | 94–96% | Effectiefste gangbare methode; verwijdert ook andere ionen |
...
De beste combinatie van effectiviteit en praktisch gebruik is een [omgekeerde osmose](/omgekeerde-osmose) systeem. Dit verwijdert naast fluoride ook nitraat, lood, PFAS, microplastics en andere ionen. Het water is daarna volledig geminimaliseerd; voor sommige mensen is remineralisatie gewenst.
